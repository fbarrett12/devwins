...
export default function WinSearchList({
  wins,
  basePath = "/wins",
  totalWins,
  totalCategories,
  ...
  return (
    <section>
      ...
      <div className="mb-6 grid gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm ring-1 ring-slate-950/2 sm:grid-cols-[1fr_220px]">
        <div>
          <label
            htmlFor="win-search"
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-950 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10"
          >
            ...
            return (
              ...
              >
                <div className="mb-3 flex items-start justify-between gap-4">
                  ...
                  <span
                    className={`shrink-0 rounded-full border px-3 py-1 text-xs font-semibold ${categoryStyle.badge}`}
                  >
                ...
                {win.impactMetric && (
                  <div
                    className={`mb-3 inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold ${categoryStyle.impact}`}
                  >
                    <span
                      aria-hidden="true"
